...
const seedDB = async () => {
    try {
        ...
        console.log('Users seeded (admin@bigmarket.com / adminpassword, user@bigmarket.com / userpassword).');
        // Seed Coupons
