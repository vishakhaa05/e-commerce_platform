...
export const createRazorpayOrder = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const verifyPaymentSignature = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
